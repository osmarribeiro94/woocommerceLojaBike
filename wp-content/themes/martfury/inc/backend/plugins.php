...
function martfury_register_required_plugins() {
	$plugins = array(
		...
		array(
			'name'               => esc_html__( 'WCBoost - Wishlist', 'martfury' ),
		...
		array(
			...
			'source'             => esc_url( 'https://github.com/drfuri/plugins/raw/main/martfury-addons.zip' ),
			'required'           => true,
			'force_activation'   => false,
			'force_deactivation' => false,
			'version'            => '3.0.2',
		...
		array(
			...
			'source'             => esc_url( 'https://github.com/drfuri/plugins/raw/main/woocommerce-deals.zip' ),
			'required'           => false,
			'force_activation'   => false,
			'force_deactivation' => false,
			'version'            => '1.0.9',
		...
		array(
			'name'               => esc_html__( 'WCBoost - Products Compare', 'martfury' ),
		...
		array(
			'name'               => esc_html__( 'WCBoost - Variation Swatches', 'martfury' ),
