...
class Martfury_VC {
	...
	function map_shortcodes() {
		...
		vc_map(
			array(
				...
				'params'      => array(
					...
					array(
						'type'       => 'dropdown',
						'heading'    => esc_html__( 'HTML Tag', 'martfury' ),
					...
					array(
						'type'       => 'dropdown',
						'heading'    => esc_html__( 'Products Source', 'martfury' ),
						'group'      => esc_html__( 'Products', 'martfury' ),
						'param_name' => 'source',
						'value'      => array(
							esc_html__( 'Default', 'martfury' ) => '1',
							esc_html__( 'Custom', 'martfury' )  => '2',
						),
					),
					array(
						'type'        => 'autocomplete',
					...
					array(
						...
						'value'       => '',
						'description' => esc_html__( 'Enter List of Products.', 'martfury' ),
						'dependency'  => array(
							'element' => 'source',
							'value'   => array( '2' ),
						),
		...
		vc_map(
			array(
				...
				'params'      => array(
					...
					array(
						'type'        => 'autocomplete',
						'heading'     => esc_html__( 'Product Brand', 'martfury' ),
						'param_name'  => 'brand',
						'settings'    => array(
							'multiple' => true,
							'sortable' => false,
						...
						'save_always' => true,
						'group'       => esc_html__( 'Products', 'martfury' ),
						'description' => esc_html__( 'Enter a product brand', 'martfury' ),
					),
					array(
						'type'        => 'textfield',
						'heading'     => esc_html__( 'Products per view', 'martfury' ),
		...
		vc_map(
			array(
				...
				'params'      => array(
					...
					array(
						'type'       => 'textfield',
						'heading'    => esc_html__( 'Ends In Text', 'martfury' ),
					...
					array(
						'type'        => 'checkbox',
						'heading'     => esc_html__( 'Show Product Variations', 'martfury' ),
						'group'       => esc_html__( 'Products', 'martfury' ),
		...
		vc_map(
			array(
				'name'        => esc_html__( 'Product Brands Grid', 'martfury' ),
				'base'        => 'martfury_brands_grid',
				'class'       => '',
				'category'    => esc_html__( 'Martfury', 'martfury' ),
				'icon'        => $this->get_icon(),
				'description' => esc_html__( 'Show multiple brands with grid.', 'martfury' ),
				'params'      => array(
					array(
						'type'        => 'textfield',
						'heading'     => esc_html__( 'Columns', 'martfury' ),
						...
						'value'       => '2',
						'group'       => esc_html__( 'Brands', 'martfury' ),
						'admin_label' => true,
					),
					array(
						'type'        => 'textfield',
						'heading'     => esc_html__( 'Numbers', 'martfury' ),
					...
					array(
						...
						'value'       => array(
							...
							esc_html__( 'Count', 'martfury' ) => 'count',
							esc_html__( 'Order', 'martfury' ) => 'order',
						),
						'group'       => esc_html__( 'Brands', 'martfury' ),
					),
					array(
					...
					array(
						...
						'value'       => array( esc_html__( 'Yes', 'martfury' ) => 'true' ),
						'group'       => esc_html__( 'Brands', 'martfury' ),
						'description' => esc_html__( 'If "YES" Enable Pagination', 'martfury' ),
					),
					array(
						'type'       => 'checkbox',
						'heading'    => esc_html__( 'Hide Products', 'martfury' ),
					...
					array(
						'type'       => 'textfield',
						'heading'    => esc_html__( 'Products per brand', 'martfury' ),
					...
					array(
						'type'       => 'textfield',
						'heading'    => esc_html__( 'Slider to show', 'martfury' ),
						'param_name' => 'slides_to_show',
						'value'      => '2',
						'group'      => esc_html__( 'Product Carousel', 'martfury' ),
					),
					array(
						'type'       => 'textfield',
						'heading'    => esc_html__( 'Slider to scroll', 'martfury' ),
					...
					array(
						'type'       => 'checkbox',
						'heading'    => esc_html__( 'Infinite', 'martfury' ),
		...
		vc_map(
			array(
				'name'        => esc_html__( 'Brand Images Grid', 'martfury' ),
				'base'        => 'martfury_brand_images',
				'class'       => '',
				'category'    => esc_html__( 'Martfury', 'martfury' ),
				'icon'        => $this->get_icon(),
				'description' => esc_html__( 'Show list image of product brand', 'martfury' ),
				'params'      => array(
					array(
						'type'       => 'textfield',
						'heading'    => esc_html__( 'Title', 'martfury' ),
					...
					array(
						...
						'value'       => '10',
						'param_name'  => 'per_page',
						'description' => esc_html__( 'Item number appears.', 'martfury' ),
					),
					array(
						'type'       => 'dropdown',
						'heading'    => esc_html__( 'Order By', 'martfury' ),
						'param_name' => 'orderby',
						'value'      => array(
							esc_html__( 'Title', 'martfury' ) => 'name',
							esc_html__( 'Count', 'martfury' ) => 'count',
							esc_html__( 'Order', 'martfury' ) => 'order',
						),
					),
					...
					array(
						...
						'value'       => '5',
						'param_name'  => 'columns',
						'description' => esc_html__( 'How much columns grid. Default columns is 5. Columns max is 10', 'martfury' ),
					),
					array(
						'type'        => 'textfield',
						'heading'     => esc_html__( 'Extra class name', 'martfury' ),
		...
		vc_map(
			array(
				'name'        => esc_html__( 'Brand Images Carousel', 'martfury' ),
				...
				'params'      => array(
					array(
						...
						'param_name' => 'title',
						'value'      => '',
						'group'      => esc_html__( 'Heading', 'martfury' ),
					),
					array(
						'type'       => 'dropdown',
						'heading'    => esc_html__( 'HTML Tag', 'martfury' ),
					...
					array(
						'heading'    => esc_html__( 'View All', 'martfury' ),
					...
					array(
						'type'       => 'textfield',
						'heading'    => esc_html__( 'Slides To Show', 'martfury' ),
						'param_name' => 'slides_to_show',
						'group'      => esc_html__( 'Carousel Settings', 'martfury' ),
						'value'      => '5',
					),
					array(
						'type'       => 'textfield',
						'heading'    => esc_html__( 'Slides To Scroll', 'martfury' ),
						'param_name' => 'slides_to_scroll',
						'group'      => esc_html__( 'Carousel Settings', 'martfury' ),
						'value'      => '5',
					),
