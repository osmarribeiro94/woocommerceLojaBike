...
A WooCommerce extension that allows guests and customers to create and add products to a wishlist.
...
= 1.0.7 =
- Improve compatibility with block themes.
- Improve the cleanup scheduled events.
