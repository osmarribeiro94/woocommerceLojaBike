 ...
 */
class Wishlist_Item extends \WC_Data_Store {

	/**
	 * Tells WC_Data_Store which object store we want to work with.
	 * This is "wcboost_wishlist_item".
	 */
	public function __construct() {
		$this->object_type = 'wcboost_wishlist_item';
	}
