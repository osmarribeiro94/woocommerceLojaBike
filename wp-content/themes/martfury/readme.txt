...
- Fix: Undefined array key "pagination_enable" in Product Carousel element

Version 3.0.1

- New: Add an option to enable one column for Product Deals Carousel
- New: Add an option to enable pagination for product grid
- New: Update Instagram icon for the Social Links widget
- Fix: Some bugs about CSS

Version 3.0.0

- New: Add new option enable the promotion on mobile
- Update: New style for the cart table on mobile
- Update: WPBakery Page Builder 6.11.0

Version 2.9.9

- Add new option to show the product vartiations for the product deals
- Add new option to enter the alt text for the footer payments
- Update: Revolution Slider 6.6.12
- Fix: Responsive columns in the Elementor product carousel

Version 2.9.8

- Add Instagram Grid element for Elementor
- Add Product Hover Style
- Fix: Some minor bugs.

Version 2.9.7

- Update: Compatible with WooCommerce 7.4.0

Version 2.9.6

- New: Use preload for the font icons
- Update: Product deals supports the variable product
- Update: Frequently Bought Together supports the variable product
- Fix: Random order in the products carousel doesn't work

Version 2.9.5

- Update: Compatible with WooCommerce 7.3.0
- Update: New vendor list style for Dokan and WCFM plugin

Version 2.9.4

- Update: Compatible with WooCommerce 7.2.1

Version 2.9.3

- New: Compatible with WCBoost – Compare
- Update: Compatible with WooCommerce 7.2.0

Version 2.9.2

- New: Compatible with WCBoost - Variation Swatches
- New: Remove recommended Variation Swatches for WooCommerce Pro plugin
- New: Support Variation images gallery
- Fix: Product Tabs Carousel doesn't work well.
...
- New: Add Home Christmas with Elementor
- New: Compatible with WCBoost – Wishlist
...
- Update: Compatible with WordPress 6.0.3
- Update: Compatible with WooCommerce 7.0.0
- Update: Revolution Slider 6.6.4
- Update: Compatible with Elementor 3.7.8
...
- Fix: Error in the widgets dashboard.
...
- Product Columns can't be changed
...
- Fix: Can't see the submenus in the category menu panel on Mobile.
